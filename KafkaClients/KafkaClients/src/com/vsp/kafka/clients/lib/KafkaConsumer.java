...
public class KafkaConsumer 
{
	 ...
	 */
	public KafkaConsumer( String zookeeper, String groupId, String topic, Properties props, Integer msgThdPoolSize ) 
	{
	...
	public void consume( int partitionCount )
	{
		...
		{
			partitionThreadPool.submit(new PartitionConsumerDelegate( stream, messageThreadPool ));
		}
	}
